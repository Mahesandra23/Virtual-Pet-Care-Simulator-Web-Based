...
function imagemakan() {
    ...
    if (image.src.match("gambar/21.png")) {
        image.src = "gambar/22.png";
        setTimeout(function() {
          image.src = "gambar/21.png";
        }, 5000);
      }
      if (image.src.match("gambar/25.png")) {
        image.src = "gambar/26.png";
        setTimeout(function() {
          image.src = "gambar/25.png";
        }, 5000);
      }
}
...
function imageobat() {
    ...
    if (image.src.match("gambar/21.png")) {
        image.src = "gambar/23.png";
        setTimeout(function() {
          image.src = "gambar/21.png";
        }, 5000);
    }
    if (image.src.match("gambar/25.png")) {
        image.src = "gambar/27.png";
        setTimeout(function() {
          image.src = "gambar/25.png";
        }, 5000);
    }
...
function imagetidur() {
    ...
    if (image.src.match("gambar/21.png")) {
        image.src = "gambar/24.png";
        setTimeout(function() {
          image.src = "gambar/21.png";
        }, 5000);
      }
      if (image.src.match("gambar/25.png")) {
        image.src = "gambar/28.png";
        setTimeout(function() {
          image.src = "gambar/25.png";
        }, 5000);
      }
...
if (gameHours >= 1 && gameLevel < 2) {
  ...
  document.querySelector(".avatar").setAttribute("src", "gambar/21.png");
  }
  if (gameHours >= 3 && gameLevel < 4) {
  gameLevel = 3;
  document.querySelector(".level").textContent = "Level 3";
  document.querySelector(".avatar").setAttribute("src", "gambar/25.png");
  }
}
